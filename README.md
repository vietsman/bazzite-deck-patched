...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  rpm-ostree rebase ostree-unverified-registry:ghcr.io/vietsman/bazzite-deck-patched:latest
  ```
...
```bash
cosign verify --key cosign.pub ghcr.io/vietsman/bazzite-deck-patched
```
